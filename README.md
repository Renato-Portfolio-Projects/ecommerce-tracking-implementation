...
> **Status:** version 0.1, foundations. The store itself is not built yet. Today the repo holds the design, the tracking plan and a holding page.
...
|---|---|---|
| 0.1 | Foundations: design, tracking plan, holding page, CI | In progress |
